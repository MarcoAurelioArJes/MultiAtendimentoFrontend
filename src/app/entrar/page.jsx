...
import { RECUPERAR_SENHA_ROTA } from '@/constants/rotasConstants'
...
export default function Entrar() {
  ...
  const entrar = (e) => {
    e.preventDefault()
    usuarioService.entrar(entrarPayload)
      .then((res) => {
        ...
        <div className='w-2/5 border-solid border-2 border-gray-20 px-6 py-9 rounded-2xl'>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a href={RECUPERAR_SENHA_ROTA} className="font-semibold text-sky-500 hover:text-sky-500">
                      Esqueceu a senha?
                    </a>
                  </div>
                </div>
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              ...
              <a href="/cadastro" className="font-semibold leading-6 text-sky-600 hover:text-sky-500">
